...
INSERT INTO Lieferungen VALUES (1, '12.11.2013', 70.00);
INSERT INTO Lieferungen VALUES (2, '03.01.2014', 140.00);
INSERT INTO Lieferungen VALUES (3, '04.01.2019', 170.00);
INSERT INTO Lieferungen VALUES (4, '12.11.2019', 170.00);
INSERT INTO Lieferungen VALUES (5, '03.01.2018', 40.00);
INSERT INTO Lieferungen VALUES (6, '04.01.2017', 270.00);
...
Select lieferantenid From BIETET_AN Where preis =  ( SELECT MIN(preis) FROM BIETET_AN Where TEILID=1);
...
select sum(numbers) from (SELECT Preis AS numbers from Teile WHERE teilID in (SELECT TeilID AS numbers from Lieferpositionen WHERE LieferungsID= 1));
